...
export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [{ title: "Sign up - Autonomous Startup-in-a-Box" }],
  }),
...
function SignupPage() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Start building visible startup-world simulations in minutes."
      footer={
        <>
    ...
    >
      <form onSubmit={submit} className="space-y-4">
        ...
        <AnimatedButton type="submit" icon={<Sparkles className="h-4 w-4" />} glowPulse className="w-full">
          Create account
        </AnimatedButton>
      </form>
    </AuthLayout>
